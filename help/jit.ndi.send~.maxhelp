...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 510.0, 236.0, 22.0 ],
									"text" : "jit.ndi.send~ MaxNDIKVM @kvm_enable 1"
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 190.0, 100.0, 32.0, 22.0 ],
													"text" : "!= 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 210.0, 220.0, 59.0, 22.0 ],
													"text" : "* 0."
												}
